...
const ALLOWED_ROLES = ['admin', 'enrolled_student', 'suspended'];
...
try {
  ...
  const updated = await prisma.user.update({
    ...
    data: {
      ...
      // If we're promoting someone who was never formally "enrolled" (e.g.
      // a user we promoted directly from pending_review), backfill the
      // enrolledAt timestamp so the admin dashboard treats them sensibly.

 ...
 *
 * Every entry declares its slug + metadata here AND lazy-imports its Vue
 * component so the main bundle stays small — each article ships as its
 * own chunk.
 *
...
export const articles = [
  ...
  },
  {
    ...
    title: 'Hiring a private Islamic tutor online: what to expect in the first month',
